...
export const navItems = [
  { to: '/', label: 'Panel principal', section: 'General', roles: ACCESO.GENERAL, desc: 'Indicadores y accesos a tus módulos' },
  ...
  { to: '/simulador-erp', label: 'Simulador ERP', section: 'Contabilidad', roles: ACCESO.CONTABILIDAD, desc: 'Eventos contables de prueba' },
